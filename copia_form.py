...
class formPrueba(Form):
    def __init__(self,screen,x,y,w,h,color_background,path_img,color_border = "black",border_size = -1,active = True):
        ...
        self.lebel_volumen = Label(self._slave,650,190,100,50,"20%","Comic Sans",15,"White","recursos de mi juego\Table.png")
        self.slider_volumen = Slider(self._slave,x,y,100,200,500,15,self.volumen,"Blue","White")
        self.btn_tabla = Button_Image(self._slave,x,y,255,100,50,50,"recursos de mi juego\Menu_BTN.png",self.btn_tabla_click,"lalaala")
        ##########################
        ...
        ############################################
        pygame.mixer.music.load("recursos de mi juego\Vengeance (Loopable).wav")
    ...
    def btn_tabla_click(self,texto):
        ...
        fmr_jugar = formMenuPlay(screen = self._master,
                    ...
                    active = True,path_image="recursos de mi juego\Window.png")
