...
while running:
    ...
    if tiempo != "terminado":
        ...
        if  segundos < 11 :
            ...
            objetivo = aclaracion.render(f"""Mision: agarra los anillos para llegar a 400 puntos como minimo y mata al boss""",True,("white"))
